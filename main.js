...
let projects = [
  {
    image: 'textures/project-myteachers.png',
    url: 'https://techyod.shop/',
  },
  {
    image: 'textures/project-wholesale.png',
    url: 'https://yodxcloud.com/',
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('Afnan Parvez', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      ' Digital Entrepreneur /Master Mind /Student',
      {
        font: font,
        size: 0.018,
        height: 0,
